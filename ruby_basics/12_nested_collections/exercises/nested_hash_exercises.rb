...
def add_information_about_language(languages, language_name, info_key, info_value)
  ...
  #my notes:
  #sounds like languages is a hash that contains a list of languages
  #info_key is a random key with information on one of the languages
  #info_value is a random value
  #language_name is the nested hash we are adding information to 
